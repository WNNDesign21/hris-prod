        ...
        if (!empty($izine)) {
            foreach ($izine as $data) {
                ...
                if ($is_can_checked){
                    ...
                    if($has_leader && $my_posisi == 5){
                        if(!$data->checked_by){
                            $checked_by = '<div class="btn-group"><button class="btn btn-sm btn-success btnChecked" data-id-izin="'.$data->id_izin.'" data-is-shift-malam="'.$is_shift_malam.'"><i class="fas fa-thumbs-up"></i> Checked</button><button type="button" class="btn btn-sm btn-danger waves-effect btnReject" data-id-izin="'.$data->id_izin.'" data-is-shift-malam="'.$is_shift_malam.'"><i class="far fa-times-circle"></i> Reject</button></div>';
                        }
                    }
                ...
                if ($is_can_approved){
                    ...
                    if(!$has_leader && $my_posisi == 4){
                        if(!$data->approved_by){
                            $approved_by = '<div class="btn-group"><button class="btn btn-sm btn-success btnApproved" data-id-izin="'.$data->id_izin.'" data-is-shift-malam="'.$is_shift_malam.'"><i class="fas fa-thumbs-up"></i> Approved</button><button type="button" class="btn btn-sm btn-danger waves-effect btnReject" data-id-izin="'.$data->id_izin.'" data-is-shift-malam="'.$is_shift_malam.'"><i class="far fa-times-circle"></i> Reject</button></div>';
                        }
                    }
