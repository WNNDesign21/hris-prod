    ...
    public function member_cuti_datatable(Request $request)
    {
        ...
        if (!empty($cutie)) {
            foreach ($cutie as $data) {
                ...
                if($data->rejected_by == null){
                    $rejected = null;
                    $posisi = Karyawan::find($data->karyawan_id)->posisi;
                    foreach($posisi as $ps){
                    ...
                    if ($jumlah_parent >= 5) {
                        if($data->checked1_by == null){
                            if(auth()->user()->karyawan->posisi[0]->jabatan_id == 5){
                                $checked1 = '<button type="button" class="waves-effect waves-light btn btn-sm btn-warning btnChecked1" data-id="'.$data->id_cuti.'"><i class="far fa-check-circle"></i> Checked</button>';
                        ...
                        if($data->checked2_by == null){
                            if(auth()->user()->karyawan->posisi[0]->jabatan_id == 4){
                                if($data->checked1_by !== null){
                                    $checked2 = '<button type="button" class="waves-effect waves-light btn btn-sm btn-warning btnChecked2" data-id="'.$data->id_cuti.'"><i class="far fa-check-circle"></i> Checked</button>';
                        ...
                        if($data->approved_by == null){
                            $approved = '<button type="button" class="waves-effect waves-light btn btn-sm btn-success btnApproved" data-id="'.$data->id_cuti.'"><i class="fas fa-thumbs-up"></i> Approved</button>';
                            if(auth()->user()->karyawan->posisi[0]->jabatan_id == 3){
                                if($data->checked2_by !== null){
                                    $approved = '<button type="button" class="waves-effect waves-light btn btn-sm btn-warning btnChecked2" data-id="'.$data->id_cuti.'"><i class="far fa-check-circle"></i> Checked</button>';
                    ...
                    // JUMLAH PARENT 3
                        ...
                        if($data->approved_by == null){
                            $btn_group_3 = '<button type="button" class="waves-effect waves-light btn btn-sm btn-success btnApproved" data-id="'.$data->id_cuti.'"><i class="fas fa-thumbs-up"></i> Approved</button>';
                            $reject3 = '<button type="button" class="waves-effect waves-light btn btn-sm btn-danger btnReject" data-id="'.$data->id_cuti.'" data-nama-atasan="'.auth()->user()->karyawan->nama.'"><i class="far fa-times-circle"></i> Reject</button>';
