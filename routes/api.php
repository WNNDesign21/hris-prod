...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/export-slip-lembur', [LembureController::class, 'export_slip_lembur']);//->name('lembure.export-slip-lembur');
    ...
    //Dropddown
    Route::get('/organisasi/get-data', [LembureController::class, 'get_data_organisasi']);
    Route::get('/departemen/get-data', [LembureController::class, 'get_data_departemen']);
    ...
    Route::middleware(['role:atasan|personalia|personalia-lembur,sanctum'])->group(function () {
        ...
        Route::patch('/approval-lembur/rejected/{idLembur}', [LembureController::class, 'rejected']);//->name('api_lembure.approval-lembur.rejected');
        Route::patch('/approval-lembur/checked/{idLembur}', [LembureController::class, 'checked']);//->name('api_lembure.approval-lembur.checked');
        Route::patch('/approval-lembur/approved/{idLembur}', [LembureController::class, 'approved']);//->name('api_lembure.approval-lembur.approved');
        Route::patch('/approval-lembur/legalized/{idLembur}', [LembureController::class, 'legalized']);//->name('api_lembure.approval-lembur.legalized');
    ...
    Route::middleware(['role:atasan|member|admin-dept,sanctum'])->group(function () {
        ...
        Route::patch('/pengajuan-lembur/done/{idLembur}', [LembureController::class, 'done']);//->name('api_lembure.pengajuan-lembur.done');
        Route::post('/pengajuan-lembur/store-lkh', [LembureController::class, 'store_lkh']);//->name('api_lembure.pengajuan-lembur.store-lkh');
        Route::patch('/pengajuan-lembur/update/{idLembur}', [LembureController::class, 'update']);//->name('api_lembure.pengajuan-lembur.update');
    });
});
