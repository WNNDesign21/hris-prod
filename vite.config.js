    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/pages/cuti/cutie-approval-cuti.js',
                ...
                'resources/js/pages/lembure-bypass-lembur.js',
                ...
                'resources/js/pages/ksk/ksk-setting.js',
                'resources/js/pages/ksk/ksk-tindak-lanjut.js',
