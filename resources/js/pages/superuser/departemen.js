$(function () {
    ...
    var departemenTable = $("#departemen-table").DataTable({
        ...
        serverSide: true,
        ajax: {
            url: base_url + "/superuser/departemen/datatable",
            dataType: "json",
            type: "POST",
    ...
    $('#form-edit-departemen').on('submit', function (e){
        ...
        let url = base_url + '/superuser/departemen/update/' + idDepartemen;
    ...
    $('#departemen-table').on('click', '.btnDelete', function (){
        ...
        Swal.fire({
            ...
            if (result.value) {
                var url = base_url + '/superuser/departemen/delete/' + idDepartemen;
                $.ajax({
                    url: url,
                    type: "POST",
                    data: {
