<aside class="main-sidebar">
        ...
        <div class="multinav">
            <div class="multinav-scroll" style="height: 100%;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    @if (auth()->user()->hasAnyRole(['personalia', 'personalia-lembur', 'super-personalia']) || auth()->user()->karyawan->posisi[0]->jabatan_id <= 4)
                    ...
                    @endif --}}
                    {{-- @if (auth()->user()->karyawan && (auth()->user()->karyawan->posisi[0]->jabatan_id <= 3 ||
                        ...
                        @endif --}}
                        {{-- Versi Pak Kuncara --}}
                        {{-- @if (auth()->user()->hasRole('atasan') && auth()->user()->karyawan->posisi[0]->jabatan_id
                        == 2 && auth()->user()->karyawan->posisi[0]->divisi_id == 3)
                        <li class="{{ $page == 'lembure-bypass-lembur' ? 'active' : '' }}">
                            <a href="{{ route('lembure.bypass-lembur') }}">
                                <i class="icon-Thunder1"><span class="path1"></span><span class="path2"></span></i>
                                <span>Bypass Lembur</span>
                        ...
                        @endif --}}
                        @if (
                                auth()->user()->hasAnyRole(['personalia', 'personalia-lembur']) ||
                                (auth()->user()->karyawan &&
    ...
    <div class="sidebar-footer d-flex justify-content-center">
        <a href="{{ route('logout') }}"
            ...
            data-bs-toggle="tooltip" title="Logout"><span class="icon-Lock-overturning"><span class="path1"></span><span
