...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
    ...
    @if ($page == 'lembure-review-lembur')
        @vite(['resources/js/pages/lembure-review-lembur.js'])
    @endif
    ...
    @if ($page == 'attendance-presensi')
        @vite(['resources/js/pages/attendance/attendance-presensi.js'])
    @endif

    @if ($page == 'attendance-rekap')
    ...
    @if ($page == 'ksk-cleareance-release')
        @vite(['resources/js/pages/ksk/cleareance/ksk-release.js'])
    @endif
