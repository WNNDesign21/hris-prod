<!-- modal Area -->
<div class="modal fade" id="modal-reject-skd">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <form action="#" method="POST" enctype="multipart/form-data" id="form-reject-skd">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="rejected_note" id="rejected_note"
                                        placeholder="Tuliskan alasan menolak Laporan SKD ini!" style="width: 100%;"></textarea>
                                </div>
